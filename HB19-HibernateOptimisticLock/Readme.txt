Optimistic Locking:
=================
When an object is loaded and performed an modification and went for a sleep for a while or did not commit for sometime,
In the meantime if any other thread have performed any modifications to the same record in DB.
