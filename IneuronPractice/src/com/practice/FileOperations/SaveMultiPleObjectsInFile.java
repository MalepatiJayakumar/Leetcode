...
import com.practice.bean.BankAccount;
...
public class SaveMultiPleObjectsInFile {
	...
	public static void main(String[] args) throws IOException, ClassNotFoundException {
		...
		BankAccount account = new BankAccount(Constants.JAI, Constants.BANK_NAME, Constants.ACCOUNT_TYPE);
...
//			System.out.println("Response :: " + output);
			...
			BankAccount accoutOutput = (BankAccount) response.getOutput().get(0);
