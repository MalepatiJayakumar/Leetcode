...
public class Servlet1 extends HttpServlet {
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		out.println(
				"<head><title>Browser</title></head><body><h1 style='text-align:center;color:green'>Please enter Student Creds to LOGIN</h1><form method='POST' action='./servlet2' style='text-align:center'> <center>");
